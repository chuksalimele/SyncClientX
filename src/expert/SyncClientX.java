...
import static expert.SyncClientX.ExitClearanceFactor.*;
import static expert.SyncClientX.TradeMode.*;
 ...
 * @author user
 */
public class SyncClientX extends ExpertAdvisorMQ4 {
...
//------------------------------------------------------
    ...
    void receivedLine(String line) {
        ...
        if ("peer_terminal_to_restart_confirm".equals(trade_packet_struct.command)) {
